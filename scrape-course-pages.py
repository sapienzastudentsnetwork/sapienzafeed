            ...
            for language_page in pages:
                ...
                if response.status_code == 200:
                    ...
                    if content_blocks:
                                    ...
                                    if content_div:
                                        ...
                                        if char_len > 800 or vertical_items > 8:
                                            ...
                                            if title_div:
                                                ...
                                                if h_tag: level_class = f"level-{h_tag.name}"
                                    ...
                                    if child_elem.name == "div" and "cdl-accordion" not in child_elem.get("class", []) and "accordion-item" not in child_elem.get("class", []):
                                        ...
                                        if char_len > 800 or vertical_items > 10:
                                            ...
                                            if first_tag and len(first_tag.get_text(strip=True)) < 100:
                                                if first_tag.name in ['h2', 'h3', 'h4', 'h5', 'h6']: level_class = f"level-{first_tag.name}"
                                                elif first_tag.name == 'strong': level_class = "level-h4"
                        ...
                        js_path = f"{rel_to_static_root}back-to-top.js"
                        ...
                        theme_bar_html = f'<div class="theme-bar"><button class="theme-toggle" onclick="toggleTheme()">🌓 Dark Mode</button></div>'
...
<body>
<h1><a href='{back_link}'>«</a> {page_heading} <a href='{url}' target='_blank' rel='noopener noreferrer'>(🌐)</a>{flag_html}</h1>
{theme_bar_html}
{toc_html}
